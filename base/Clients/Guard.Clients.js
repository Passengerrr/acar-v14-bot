const { Client, Collection, GatewayIntentBits, Partials, Constants, ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, Options} = require("discord.js");
...
Aşağıda bulunan düğme ile tekrardan aktif edebilirsin. Bunun için sunucu sahibi veya bot sahibi olmalısın.`)], components: [Rows]}).then(async (msg) => {
                    ...
                    collector.on('collect', async (i) => {
                        ...
                        i.reply({embeds: [new EmbedBuilder().setColor("Random").setDescription(`
