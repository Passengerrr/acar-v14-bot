...
module.exports = async (channel) => {
    ...
    let embed = new EmbedBuilder().setTitle("Sunucuda Webhook Oluşturuldu!")
    ...
    embed.setColor("Random").setDescription(`${entry.executor} (\`${entry.executor.id}\`) tarafından \`${channel.name}\` kanalında webhook oluşturuldu ve oluşturulduğu gibi silinip cezalandırıldı.`);
