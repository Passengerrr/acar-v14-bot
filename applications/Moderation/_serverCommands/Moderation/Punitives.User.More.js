...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!atılanCezalar) return message.reply({content: `${cevaplar.prefix} ${cartelcim} isimli üyenin daha önce yaptırım uyguladığı ceza-i işlem bulunamadı.`});
