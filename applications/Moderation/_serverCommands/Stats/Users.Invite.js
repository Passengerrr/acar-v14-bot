...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    message.channel.send({
      embeds: [new EmbedBuilder().setAuthor({name: member.user.username, iconURL: member.user.avatarURL({ dynamic: true })}).setDescription(`${member} isimli üye toplam **${total + bonus}** (**Bonus**: \` +${bonus} \`) davete sahip. (**${regular}** giren, ${ayarlar.type ? ` **${tagged}** taglı, ` : ``}**${leave}** ayrılmış, **${fake}** sahte, **${daily}** günlük, **${weekly}** haftalık)
