...
module.exports = async role => {
    ...
    embed.setColor("Random").setDescription(`${entry.executor} (__${entry.executor.id}__) tarafından ${role.name} (__${role.id}__) rolü silindi. \`${sistem.botSettings.Prefixs[0]}rolkur ${role.id}\` komutu ile kurulum yapabilirsiniz.`);
