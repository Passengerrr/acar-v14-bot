...
module.exports = async (guild) => {
    ...
    let embed = new EmbedBuilder().setTitle("Sunucuda Entegrasyon Oluşturuldu!")
    ...
    embed.setColor("Random").setDescription(`${entry.executor} (\`${entry.executor.id}\`) tarafından entegrasyonları oluşturuldu ve oluşturulduğu gibi cezalandırıldı.`);
