...
module.exports = async (ban) => {
    ...
    embed.setColor("Random").setDescription(`${ban.user} (\`${ban.user.id}\`) üyesi, ${entry.executor} (\`${entry.executor.id}\`) tarafından sunucudan \`Sağ-Tık\` ile yasaklandı! yasaklayan kişi ise yasaklandı.`);
