...
module.exports = async (guild) => {
    ...
    let embed = new EmbedBuilder().setTitle("Sunucuda Entagrasyon Silindi!")
    ...
    embed.setColor("Random").setDescription(`${entry.executor} (\`${entry.executor.id}\`) tarafından entegrasyonlar silindi ve silindiği gibi cezalandırıldı.`);
