...
module.exports = async (channel) => {
  ...
  if(Data && !Data.channelGuard) return;
    let embed = new EmbedBuilder().setTitle("Sunucuda Kanal Silindi!")
    ...
    embed.setColor("Random").setDescription(`${entry.executor} (\`${entry.executor.id}\`) tarafından \`#${channel.name}\` isimli kanal silindi ve geri oluşturularak yapan kişi yasaklandı.`);
