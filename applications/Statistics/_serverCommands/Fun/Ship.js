...
module.exports = {
   ...
   */
    ...
    onRequest: async function (client, message, args) {
        ...
        person._views()
        if(özel.includes(person.id)) return message.reply({content: `${message.guild.emojiGöster(emojiler.no_cartel)} Tabi Efendim Ship Atarsın.`}).then(x => {
